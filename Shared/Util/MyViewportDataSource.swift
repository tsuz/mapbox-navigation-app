 ...
 */
class MyViewportDataSource: ViewportDataSource {
    ...
    func cameraOptions(_ location: CLLocation?, routeProgress: RouteProgress? = nil) -> [String: CameraOptions] {
        ...
        followingMobileCamera.zoom = 17.5
        followingMobileCamera.pitch = 65.0
...
extension MyViewportDataSource: LocationConsumer {
